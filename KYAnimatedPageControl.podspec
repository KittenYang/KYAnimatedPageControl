...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/KittenYang/KYAnimatedPageControl"
  ...
  s.source       = { :git => "https://github.com/KittenYang/KYAnimatedPageControl.git", :tag => s.version.to_s }
  ...
  s.source_files  = "KYAnimatedPageControl-Demo/Classes/**/*.{h,m}"

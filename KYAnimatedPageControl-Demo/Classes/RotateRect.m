...
- (void)restoreAnimation:(id)howmanydistance {
  ...
  //    CAKeyframeAnimation *anim = [KYSpringLayerAnimation
  //    createSpring:@"index" duration:0.5 usingSpringWithDamping:0.5
  //    initialSpringVelocity:3 fromValue:@(fromValue) toValue:@(0)];
  //    _index = 0;
